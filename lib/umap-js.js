...
Object.defineProperty(exports, "__esModule", { value: true });
exports.argsort = exports.reshape2d = exports.rejectionSample = exports.max2d = exports.max = exports.mean = exports.sum = exports.linear = exports.ones = exports.zeros = exports.filled = exports.range = exports.empty = exports.norm = exports.tauRand = exports.tauRandInt = void 0;
...
function argsort(x) {
    var result = range(x.length);
    result.sort(function (a, b) { return x[a] - x[b]; });
    return result;
}
...
var ml_levenberg_marquardt_1 = __importDefault(__webpack_require__(4));
